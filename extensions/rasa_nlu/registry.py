...
from rasa_nlu.extractors.custom_spacy_entity_extractor_remote import RemoteSpacyCustomNER
...
component_classes = [
    ...
    CRFEntityExtractor, DucklingHTTPExtractor, RemoteSpacyCustomNER,
    EntitySynonymMapper,
